...
void	ra(t_piles *pile, int bonus);
void	rb(t_piles *pile, int bonus);
void	rr(t_piles *pile, int bonus);
void	rra(t_piles *pile, int bonus);
void	rrb(t_piles *pile, int bonus);
void	rrr(t_piles *pile, int bonus);
